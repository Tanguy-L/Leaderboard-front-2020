    ...
    <v-row class="pa-2 ps-3">
        ...
        <v-list-item v-if="!edit.isEdited">
          <v-list-item-content class="text-left">
            ...
            <v-list-item-subtitle
              ...
              {{ match.rule.equality }}</v-list-item-subtitle
            >
          </v-list-item-content>
        </v-list-item>
        <v-list-item v-else>
      ...
      <v-col>
        <v-card-actions style="height:100%" v-if="amIAdmin">
          <v-container v-if="!edit.isEdited">
            <v-btn icon>
          ...
          <v-container class="d-flex justify-end" v-else>
            <v-btn icon @click.native="editMatch()">
